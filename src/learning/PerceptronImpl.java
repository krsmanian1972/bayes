...
class PerceptronImpl
{
	...
	public static void main(String args[])
	{
		...
		// 3 for input variables and one for bias
		...
		// notice the range of -10 and 10 means the new point could be of class
		// 1 or 0
		// -10 to 10 covers all the ranges we used in generating the 50 classes
		// of 1's and 0's above
		for (int j = 0; j < 10; j++)
		{
			...
			output = calculateOutput(weights, x1, y1, z1);
			System.out.println("\n=======\nNew Random Point:");
	...
	/**
	 * returns either 1 or 0 using a threshold function theta is 0range
	 * 
	 * @param theta
	 *            an integer value for the threshold
	 * @param weights[]
	 ...
	 * @return 1 or 0
	 */
	static int calculateOutput(double weights[], double x, double y, double z)
	{
